...
my $PATH="/ifshk4/BC_PUB/biosoft/pipe/bc_tumor/newblc/R-3.4.0/bin/:/ifshk4/BC_PUB/biosoft/pipe/bc_tumor/newblc/Meerkat/bin/:\$PATH";
#my $PATH="/share/backup/luowen/install/meerkat/Meerkat/bin/:\$PATH";
#my $LD_LIBRARY_PATH="$Bin/src/mybamtools/lib/:\$LD_LIBRARY_PATH";
my $LD_LIBRARY_PATH="/ifshk4/BC_PUB/biosoft/pipe/bc_tumor/newblc/Meerkat/src/mybamtools/lib/:\$LD_LIBRARY_PATH";
...
AnaMethod::generateShell($meerkat_c,$content);
print TXT "$meerkat_c:$qsubMemory[0]\n";
